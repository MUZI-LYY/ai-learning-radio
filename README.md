...
> **项目状态：早期公开版本。** 当前检查点为 `v0.3.0-frontend`，核心本地链路已经可运行；系统仍以单机 SQLite、本地文件存储和轮询 Worker 为主，尚未按高并发、容灾或多租户生产环境完成加固。
...
它目前更适合个人本地使用、产品研究和受控试用，不是开箱即用的大规模公共内容平台。
...
- [MVP 需求总结](AI学习电台-MVP需求总结.md)
- [架构推导方案](AI学习电台-架构推导方案.md)
- [第一阶段技术开发文档](第一阶段技术开发文档-私人学习播客最小闭环.md)
- [每日资讯单 Agent 设计方案](每日资讯单Agent设计方案.md)
- [技术适配声明](技术适配声明.md)
